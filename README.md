...
4) open your terminal and type in 'cd your_path' and press enter
5) now type in 'pyinstaller --onefile --noconsole --icon=icon.ico --name "NyanCat Launcher" nyan_app.py'
6) you will find your .exe file in a folder called dist
